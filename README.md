...
При запуске в **интерактивном терминале** приложение стартует в живом дашборде
...
у банкомата: тематический этап обслуживания (вставляет карту → вводит PIN-код →
… → забирает карту, сценарий зависит от операции) и прогресс в процентах;
